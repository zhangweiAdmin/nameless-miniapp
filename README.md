...
- 匿名纸条列表：分类筛选、最火/最新排序、分页加载；未确认昵称也可浏览。
- 纸条卡片：点赞、表情回应、分享解锁、发送者昵称解锁、举报。
- 匿名投递页：进入发布前必须确认昵称；分类选择、模板文案、自定义文案每日 3 次直接使用，之后分享小程序继续使用，发布时自动使用已确认昵称。
- 我的页：我匿名投递过的纸条、我解锁过的发送者昵称、群管理修改名称。
- 云函数：匿名投递、列表、点赞、表情、分享活动、解锁、群绑定、群名更新、我的数据、举报、软删除。
